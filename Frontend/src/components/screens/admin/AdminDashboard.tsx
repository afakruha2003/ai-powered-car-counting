...
import { Car, DollarSign, Users, TrendingUp, ChevronDown, Settings } from 'lucide-react';
...
const hourlyData = [
  ...
  { hour: '10:00', vehicles: 28 },
  { hour: '12:00', vehicles: 45 },
  { hour: '14:00', vehicles: 52 },
  { hour: '16:00', vehicles: 48 },
  { hour: '18:00', vehicles: 35 },
];

export default function AdminDashboard({ onManageClick }: AdminDashboardProps) {
  return (
      ...
      <div className="p-6 space-y-6 mt-[-2px] mr-[0px] mb-[0px] ml-[0px]">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-white rounded-[16px] p-4 shadow-md">
            ...
            <div className="text-2xl text-[#3D5AFE] mb-1">847</div>
            <div className="text-xs text-gray-500">Cars Today</div>
          </div>
          ...
          <div className="bg-white rounded-[16px] p-4 shadow-md">
            ...
            <div className="text-2xl text-[#4CAF50] mb-1">$2,541</div>
          ...
          <div className="bg-white rounded-[16px] p-4 shadow-md">
            ...
            <div className="text-2xl text-[#FFC107] mb-1">68%</div>
        ...
        <div className="bg-white rounded-[16px] p-6 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gradient-to-br from-[#3D5AFE]/5 to-[#536DFE]/5 rounded-[12px] p-4">
              ...
              <div className="flex items-end gap-2">
                <span className="text-3xl text-[#3D5AFE]">82</span>
                <span className="text-sm text-gray-500 mb-1">of 120</span>
              </div>
            </div>
            <div className="bg-gradient-to-br from-[#4CAF50]/5 to-[#4CAF50]/10 rounded-[12px] p-4">
              ...
              <div className="flex items-end gap-2">
                <span className="text-3xl text-[#4CAF50]">38</span>
          ...
          <div className="mt-4">
            <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
              <div className="h-full bg-gradient-to-r from-[#3D5AFE] to-[#536DFE]" style={{ width: '68%' }} />
            </div>
        ...
        <div className="bg-gradient-to-br from-[#4CAF50] to-[#66BB6A] rounded-[16px] p-6 shadow-md text-white">
          <div className="flex items-start justify-between mb-4">
            <div>
              <p className="text-white/90 text-sm mb-2">Revenue This Month</p>
              <p className="text-3xl">$31,31</p>
            </div>
